...
> **What this is.** A conjecture-and-refutation discipline built on the Thurisaz
> Technique — the epistemic method that underwrites the fleet's *refuter, not
> validator* stance (see [`THURISAZ-WORKING-MODE.md`](THURISAZ-WORKING-MODE.md) and
> [`REFUTATION-WORKING-PROCESS.md`](REFUTATION-WORKING-PROCESS.md)). It is
> project-agnostic: it says how any claim, design, or plan earns confidence, and is
> reproduced here so the discipline travels with the repo. Under this method the
> agent is a **refuter, not a validator**.
...
Under this method the assistant is a **refuter, not a validator**.
